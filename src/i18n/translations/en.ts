...
const en: Translations = {
  ...
  auth_temp_access: "Temporary access",
  auth_temp_access_title: "Temporary access",
  auth_temp_access_desc: "Enter your access code to sign in.",
  auth_temp_access_code_placeholder: "Access code",
  auth_temp_access_invalid: "Invalid or expired code.",
  auth_temp_expired: "Your temporary access has expired.",
  auth_reset_send_title: "Reset password",
  auth_reset_send_desc: "Enter your email and we'll send you a link to set a new password.",
  auth_reset_send_btn: "Send reset link",
  auth_reset_sent: "If an account exists for this email, you'll receive a link to reset your password.",
  auth_reset_new_title: "Set new password",
  auth_reset_new_desc: "Choose a new password that meets the security requirements.",
  ...
  auth_reset_invalid_link: "Invalid or expired link. Request a new reset link from the login page.",
  ...
  add_car_use_custom_brand: (name: string) => `Use "${name}"`,
  add_car_use_custom_model: (name: string) => `Use "${name}"`,
  add_car_custom_year_placeholder: "Enter year (e.g. 2020)",
  add_car_pending_review: "Pending review",
  add_car_pending_review_info: "This vehicle uses an unlisted brand or model. An administrator must validate it.",
  add_car_photo: "Photo",
  ...
  profile_support_desc: "Ask a question or report an issue",
  profile_sign_out: "Sign out",
  dm_no_conversations: "No conversations",
  dm_search_to_start: "Use the search bar to start a conversation",
  dm_pending_requests: "Conversation requests",
  ...
  // Channel names and descriptions (by slug: general, mecanique, confirmation-spots)
  channel_general_name: "General",
  channel_general_desc: "General discussions",
  channel_mecanique_name: "The Mechanics",
  channel_mecanique_desc: "Let's talk car mechanics",
  channel_confirmation_spots_name: "Spot confirmation",
  channel_confirmation_spots_desc: "Confirm your spots with fellow enthusiasts",
  ...
  card_condition_destroyed: "Destroyed",
  ...
  pwa_install_dismiss: "Maybe later",
