      ...
      <AnimatePresence mode="wait">
        <Suspense fallback={<PageLoader />} key={location.pathname}>
          <Routes location={location} key={location.pathname}>
            ...
            />
            <Route
              path="/deliver-car/select-friend"
              element={
                <ProtectedRoute>
                  <PageTransition>
                    <DeliverSelectFriend />
            ...
            />
            <Route
              path="/card-game/world-domination"
              element={
                <ProtectedRoute>
                  <PageTransition>
                    <WorldDomination />
